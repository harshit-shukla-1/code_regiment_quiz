...
export const defaultQuestions: Question[] = [
  ...
  {
    id: 21,
    text: "Which two pins are used for I2C communication on a standard Arduino UNO?",
    options: ["D0 and D1", "D10 and D11", "A4 (SDA) and A5 (SCL)", "Digital 2 and 3"],
    correctAnswer: 2
  },
  {
    id: 22,
    text: "What is the typical operating voltage for a standard Arduino UNO powered via the USB port?",
    options: ["3.3V", "5V", "9V", "12V"],
    correctAnswer: 1
  },
  {
    id: 23,
    text: "In electronics, what does a resistor with color bands Brown, Black, Red, Gold represent?",
    options: ["100 Ohms", "1,000 Ohms (1k)", "10,000 Ohms (10k)", "220 Ohms"],
    correctAnswer: 1
  },
  {
    id: 24,
    text: "Which sensor would be most effective for a line-following robot to detect a black line on a white surface?",
    options: ["Ultrasonic Sensor", "Inertial Measurement Unit", "Infrared (IR) Reflectance Sensor", "DHT11 Temperature Sensor"],
    correctAnswer: 2
  },
  {
    id: 25,
    text: "What is the maximum current that a single Arduino digital output pin should safely provide?",
    options: ["20mA to 40mA", "200mA", "1 Amp", "500mA"],
    correctAnswer: 0
  },
  {
    id: 26,
    text: "Which type of motor provides the most precise control over rotation angle without needing a feedback sensor?",
    options: ["DC Motor", "Stepper Motor", "Brushed Motor", "AC Motor"],
    correctAnswer: 1
  },
  {
    id: 27,
    text: "What does the 'S' in a '3S' Li-Po battery pack indicate?",
    options: ["The speed of the battery.", "The number of cells connected in series.", "The size of the battery.", "The safety rating."],
    correctAnswer: 1
  },
  {
    id: 28,
    text: "Which Arduino command is used to send a value to a PWM-enabled pin?",
    options: ["digitalWrite()", "digitalRead()", "analogWrite()", "analogRead()"],
    correctAnswer: 2
  },
  {
    id: 29,
    text: "What is the purpose of a 'Pull-up' resistor in a button circuit?",
    options: ["To increase the current to the button.", "To ensure the input pin stays at a stable HIGH state when the button is open.", "To prevent the button from getting hot.", "To speed up the code execution."],
    correctAnswer: 1
  },
  {
    id: 30,
    text: "The MPU6050 communicates with the Arduino using which protocol?",
    options: ["UART", "SPI", "I2C", "Analog"],
    correctAnswer: 2
  },
  {
    id: 31,
    text: "What is the default baud rate often used for the Arduino Serial Monitor?",
    options: ["300", "1200", "9600", "115200"],
    correctAnswer: 2
  },
  {
    id: 32,
    text: "Which component is used to protect the Arduino from the 'Back EMF' generated by a DC motor?",
    options: ["Capacitor", "Flyback Diode", "Transistor", "LED"],
    correctAnswer: 1
  },
  {
    id: 33,
    text: "What is the standard range of a 180-degree hobby servo's pulse width?",
    options: ["0ms to 5ms", "1ms to 2ms", "5ms to 10ms", "0.1ms to 0.5ms"],
    correctAnswer: 1
  },
  {
    id: 34,
    text: "Which Arduino library is commonly used to control standard hobby servos?",
    options: ["Wire.h", "Servo.h", "SPI.h", "LiquidCrystal.h"],
    correctAnswer: 1
  },
  {
    id: 35,
    text: "What happens if you use 'delay(1000)' in your Arduino code?",
    options: ["The code runs faster.", "The processor pauses all execution for 1 second.", "It creates a background timer.", "It clears the memory."],
    correctAnswer: 1
  },
  {
    id: 36,
    text: "A '7805' component is commonly used for what purpose?",
    options: ["Switching high voltage.", "Voltage regulation (outputs stable 5V).", "Measuring temperature.", "Bluetooth connection."],
    correctAnswer: 1
  },
  {
    id: 37,
    text: "Which sensor is best suited for detecting the presence of a magnetic field?",
    options: ["Hall Effect Sensor", "Photoresistor (LDR)", "Thermistor", "Piezo Sensor"],
    correctAnswer: 0
  },
  {
    id: 38,
    text: "What is the main difference between an Active Buzzer and a Passive Buzzer?",
    options: ["Active buzzers are louder.", "Active buzzers generate their own tone when powered; passive buzzers need a PWM signal.", "Passive buzzers are waterproof.", "Active buzzers use more voltage."],
    correctAnswer: 1
  },
  {
    id: 39,
    text: "In a PID controller, what does the 'D' (Derivative) term primarily help with?",
    options: ["Increasing the speed of the motor.", "Reducing overshoot and dampening oscillations.", "Providing steady-state accuracy.", "Connecting to the internet."],
    correctAnswer: 1
  },
  {
    id: 40,
    text: "What is the resolution of the Arduino UNO's Analog-to-Digital Converter (ADC)?",
